    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adecuacion_ingesta', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='% Adecuación Ingesta')),
                ('porcentaje_GET', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='%  Calorías a planificar = %GET')),
            ],
            options={
