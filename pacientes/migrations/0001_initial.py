    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_brazo_contraido', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Perimt.Brazo contraido(cm)')),
                ('d_humero', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Diámetro Húmero(cm)')),
                ...
                ('p_abdominal', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Perimetro Abdominal(Cm)')),
