document.addEventListener('DOMContentLoaded', function(){
   ...
   function calcularOMS(edad, genero, pesoActual) {
    ...
    function TotalEnergiaActividad() {
        let totalEnergia = 0;
        // Seleccionar todos los elementos de energía de actividad
        ...
        // Sumar los valores de energía de actividad
        energiaElementos.each(function () {
            let energiaActividadValue = parseFloat($(this).val()) || 0;
            totalEnergia += energiaActividadValue;
        });
    
        // Obtener los campos de salida
        ...
        if (caloriasField.length) {
            ...
            // Esperar un pequeño tiempo antes de calcular el coeficiente
            setTimeout(() => {
